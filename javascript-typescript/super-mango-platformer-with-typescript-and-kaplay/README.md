...
An implementation of Super Mango platformer based on the classical Nintendo game Super Mario Bros with Typescript and the game engine [Kaplay](https://github.com/kaplayjs/kaplay).
...
<img src="Mango_Platformer.png" width="75%" height="75%">
