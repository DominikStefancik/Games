import { generateMappings } from "../general-mapping";

export const level2Mappings = generateMappings("brick");

/*
 * Defines a layout for the second level. Each element of the array represents a layer
 * Each symbol in the layer is defined in the general mapping
 */
