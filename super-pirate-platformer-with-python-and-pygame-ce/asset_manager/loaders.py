...
def load_level_graphics():
    return {
        ImageAssetGroup.FLAG.value: import_folder_as_list(
            "assets", "graphics", "level", "flag"
        ),
        ImageAssetGroup.SAW.value: import_folder_as_list(
        ...
        ImageAssetGroup.BIG_CHAIN.value: import_folder_as_list(
        ...
        ImageAssetGroup.HELICOPTER.value: import_folder_as_list(
            "assets", "graphics", "level", "helicopter"
        ),
        ImageAssetGroup.BOAT.value: import_folder_as_list(
        ...
        ImageAssetGroup.TOOTH.value: import_folder_as_list(
        ...
        ImageAssetGroup.PARTICLE.value: import_folder_as_list(
            "assets", "graphics", "effects", "particle"
        ),
        ImageAssetGroup.HEART.value: import_folder_as_list(
            "assets", "graphics", "ui", "heart"
        ),
        ImageAssetGroup.WATER_TOP.value: import_folder_as_list(
            "assets", "graphics", "level", "water", "top"
        ),
        ImageAssetGroup.WATER_BODY.value: import_image(
            "assets", "graphics", "level", "water", "body"
        ),
        ImageAssetGroup.BACKGROUND_TILES.value: import_folder_as_dict(
            "assets", "graphics", "level", "bg", "tiles"
        ),
        ImageAssetGroup.CLOUD_SMALL.value: import_folder_as_list(
...
def load_ui_graphics():
    return {
        ...
        ImageAssetGroup.COIN.value: import_image("assets", "graphics", "ui", "coin"),
    }
