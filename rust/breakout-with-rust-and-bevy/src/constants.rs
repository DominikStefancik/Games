...
pub const BALL_COLOR: Color = Color::srgb(1., 0.5, 0.5);
...
pub const BRICK_COLOR: Color = Color::srgb(0.5, 0.5, 1.);
...
pub const SCOREBOARD_TEXT_COLOR: Color = Color::srgb(0.5, 0.5, 1.);
pub const SCOREBOARD_SCORE_COLOR: Color = Color::srgb(1., 0.5, 0.5);
