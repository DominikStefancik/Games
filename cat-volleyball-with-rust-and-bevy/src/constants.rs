...
pub const SPRITES_SHEET_SIZE: UVec2 = UVec2::new(58, 34);
pub const LEFT_CAT_TEXTURE_CORNER: UVec2 = UVec2::new(11, 1);
pub const RIGHT_CAT_TEXTURE_CORNER: UVec2 = UVec2::new(35, 1);
pub const CAT_SIZE: UVec2 = UVec2::new(PLAYER_WIDTH as u32, PLAYER_HEIGHT as u32);
pub const BALL_TEXTURE_CORNER: UVec2 = UVec2::new(1, 1);
pub const BALL_SIZE: UVec2 = UVec2::new(8, 8);
